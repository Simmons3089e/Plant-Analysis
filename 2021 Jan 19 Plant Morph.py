...
roi1, roi_hierarchy= pcv.roi.rectangle(img=img1, x=60, y=20, h=20, w=20)
...
#img1, seg_img, edge_objects = pcv.morphology.prune(skel_img=skeleton, size=1, mask=cropped_mask)
